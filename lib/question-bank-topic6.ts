...
export const topic6Questions: Question[] = [
  ...
  // Question 551 - Answer: D
  {
    ...
    option_a: 'pull_request_review for formal review submissions',
    option_b: 'pull_request_review_comment for inline code discussions',
    option_c: 'discussion_comment for threaded conversations',
  ...
  // Question 601 - Answer: C
  {
    ...
    option_a: 'Maximize automation coverage across the development lifecycle',
    option_b: 'Reduce time-to-market through accelerated development velocity',
    option_c: 'Create a multi-layered quality system with automated planning, review, and human oversight',
    option_d: 'Standardize development practices across distributed teams',
    correct_answer: 'C',
